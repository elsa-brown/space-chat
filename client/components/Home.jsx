        ...
        <div id="instructions" className="container">
          ...
          <div className="row">
            <div className="col-md-4 col-xs-12">
              ...
              <p className="instructions-p">Use Spacechat on a desktop or mobile device with a VR headset. Enter one of four virtual words and experience an online chatroom like never before.</p>
            </div>
